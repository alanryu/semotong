	...
	public Map<String, Object> sendOrder(int id) {
		...
		try {
			...
			if("01".equals(order.getEntrType())) {
				...
				if(preTelecomCd.endsWith("M")) {
					...
					if(StringUtils.isNotBlank(preMvnoCd)) {
						...
						String preMvnoNm = codeService.getCode(cmmCodeParam) != null ? codeService.getCode(cmmCodeParam).getCodeName() : "";					
			...
			if("01".equals(order.getSettleMethod())) {
				...
				String gogoBankCode = codeService.getCode(cmmCodeParam) != null ? codeService.getCode(cmmCodeParam).getCode() : "";	
				...
				String gogoCardCode = codeService.getCode(cmmCodeParam) != null ? codeService.getCode(cmmCodeParam).getCode() : "ETC";
