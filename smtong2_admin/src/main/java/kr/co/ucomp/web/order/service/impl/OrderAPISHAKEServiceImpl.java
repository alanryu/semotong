	...
	public Map<String, Object> sendOrder(int id) {
		...
		try {
			...
			if("01".equals(order.getSettleMethod())) {
				...
				String bankCodeSHAKE = codeService.getCodeInfo(cmmCodeParam) != null ? codeService.getCodeInfo(cmmCodeParam).getCode() : "";
				String bankNameSHAKE = codeService.getCodeInfo(cmmCodeParam) != null ? codeService.getCodeInfo(cmmCodeParam).getCodeName() : "";
