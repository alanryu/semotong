...
public class PlanFreebieContoroller {
    ...
    public ResponseEntity<CustomApiResponse<PlanFreebieEntity>> createInfo(  HttpServletRequest request, HttpServletResponse response,
    ...
    public ResponseEntity<CustomApiResponse<PlanFreebieEntity>> updateInfo(  HttpServletRequest request, HttpServletResponse response,
    		@RequestBody  PlanFreebieEntity record
    		) throws IOException {
    	try {
    ...
    public ResponseEntity<CustomApiResponse<PlanFreebieMappingEntity>> createmap(  HttpServletRequest request, HttpServletResponse response,
    ...
    public ResponseEntity<CustomApiResponse<PlanFreebieMappingEntity>> updatemap(HttpServletRequest request, HttpServletResponse response,
    		@RequestBody  PlanFreebieMappingEntity record
    		) throws IOException {
    	try {
    		...
    		PlanFreebieMappingEntity  mapinfo =  service.mapDetail(updateId);
    		PlanEntity plan = planService.getDetail(rateid);
    		PlanFreebieEntity  freebie =  service.infoDetail(freebieid);
    ...
    public ResponseEntity<CustomApiResponse<PlanFreebieMappingEntity>> updatemapOrder( HttpServletResponse response,
    		@RequestBody  PlanFreebieMappingEntity record
    		) throws IOException {
    	try {
