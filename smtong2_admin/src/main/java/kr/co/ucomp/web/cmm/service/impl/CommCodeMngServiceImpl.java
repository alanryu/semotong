...
public class CommCodeMngServiceImpl implements CommCodeMngService {
	...
	@Override
	@Transactional
	public long createCodeGroup(CodeGroupDto param) {
		return mapper.createCodeGroup(param);
	...
	@Override
	@Transactional
	public long updateCodeGroup(CodeGroupDto param) {
		
		return mapper.updateCodeGroup(param);
	...
	@Override
	@Transactional
	public long delCodeGroup(@Param("codeGroup") String param) {
		
		return mapper.delCodeGroup(param);
	}
	...
	@Override
	@Transactional(readOnly = true)
	public CodeEntity getCode(@Param("codeGroup") String codeGroup,@Param("code") String code) {
		CodeEntity record = mapper.getCode(codeGroup,code);
		return record;
	}
	...
	@Override
	@Transactional(readOnly = true)
	public CodeEntity getCodeInfo(CommCodeSearchDto param) {
		CodeEntity record = mapper.getCodeInfo(param);
		return record;
	}
	...
	@Override
	@Transactional
	public long createCode(CommCodeDto param) {
		return mapper.createCode(param);
	...
	@Override
	@Transactional
	public long updateCode(CommCodeDto param){
	...
	@Override
	@Transactional
	public long delCode(@Param("codeGroup") String codeGroup,@Param("code") String code) {		
		return mapper.delCode(codeGroup,code);
	}
