...
import kr.co.ucomp.web.pmb.mapper.PlanBenefitMapper;
...
public class PlanBenefitServiceImpl implements PlanBenefitService {
    ...
    @Override
    public List<PlanBenefitMappingEntity> mapDetailBenefit(int id) {
        return mapper.mapDetailBenefit(id);
    }
    ...
    @Override
    public long updatemapOrder(PlanBenefitMappingEntity param) {
    ...
    @Override
    public long deletemapBenefit(int id) {
        return mapper.deletemapBenefit(id);
    }
    ...
    @Override
    public long deleteBenefit(int id, int modifiedId) {
        return mapper.deleteBenefit(id, modifiedId);
