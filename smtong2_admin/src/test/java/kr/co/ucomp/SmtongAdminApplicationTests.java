...
@SpringBootTest
public class SmtongAdminApplicationTests {
    ...
    public void connection_test() {
        ...
        System.out.println("Decrypted Database URL: " + decryptValue(encryptedUsername));
        System.out.println("Decrypted Database Username: " + decryptValue(encryptedUsername));
        System.out.println("Decrypted Database Password: " + decryptValue(encryptedPassword));
        
        System.out.println("Decrypted redishost: " + decryptValue(redishost));
        System.out.println("Decrypted redispassword: " + decryptValue(redispassword));
		 
		/*
		 * String decryptedUrl = decryptValue(encryptedUrl); String decryptedUsername =
		 * decryptValue(encryptedUsername); String decryptedPassword =
		 ...
		 * 
		 * // 프로파일이 'prod'인 경우 데이터베이스 연결 테스트 생략 if (isProdProfile(activeProfiles)) {
		 * System.out.println("'prod' 프로파일에서는 데이터베이스 연결 테스트를 건너뜁니다."); return; }
		 * 
		 * // 데이터베이스 연결 테스트 try (Connection con =
